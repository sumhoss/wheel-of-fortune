...
/**
 *  The Rotation allows you to change the orientation of an Icon by
...
public class Rotation implements Icon
{
  public enum Rotate
  {
    DOWN,
  ...
  /**
   *  Convenience constructor to create a Rotation that is rotated DOWN.
   *
   *  @param icon  the Icon to rotate
   */
  public Rotation(Icon icon)
  {
    this(icon, Rotate.UP);
  }
   ...
   */
  public Rotation(Icon icon, Rotate rotate)
  {
    this.icon = icon;
    this.rotate = rotate;
  }
   ...
   */
  public Rotation(Icon icon, double degrees, boolean circularIcon)
  {
